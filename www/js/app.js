...
angular.module('citizen-engagement', ['ionic', 'citizen-engagement.auth', 'citizen-engagement.constants', 'infinite-scroll','geolocation', 'leaflet-directive'])
  ...
  $stateProvider
    ...
    .state('tab.issueDetails', {
      ...
      views: {
        ...
        'tab-issueList': {
          controller: 'LoginCtrl', // A mettre à ce niveau là lorsqu'il y a un tab.x

...
![Alt text](/readme/image1.png "Login page") { float: right; }
![Alt text](/readme/image2.png "Issue creation page") { float: right; }
![Alt text](/readme/image3.png "Issues map page") { float: right; }
